...
//         public async Task NewOrigins3(PerformContext context, long gameId) {
...
//             var jobIds = downloadJobs.ToArray();

//             backgroundJobs.Create<RemoteGameServerJobs>(
//                 x => x.CombineReportsAsync(),
//                 new JoiningState(
//                     downloadJobs,
//                     new EnqueuedState(),
...
//             logger.LogInformation($"Local turn number is {localTurnNumber}");
//         }
//     }
