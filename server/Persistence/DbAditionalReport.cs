namespace advisor.Persistence {
    ...
    public class DbAditionalReport : InTurnContext {
        [GraphQLIgnore]
        [NotMapped]
        ...
        public static ReportId MakeId(DbAditionalReport report) => (report.PlayerId, report.TurnNumber, report.FactionNumber);

        public static IQueryable<DbAditionalReport> FilterById(IQueryable<DbAditionalReport> q, ReportId id) {
